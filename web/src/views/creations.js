...
export const renderCreationsView = ({ content, doc, creations, onSnapshot, onClearAll, onDelete, onRestore, onDownload, onExportJson, loadPreview, }) => {
    if (!content) {
        return;
    }
    content.innerHTML = `
