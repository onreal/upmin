...
export const findAuthDocumentId = (pages) => {
...
const renderNavList = (container, pages, mode, onSelectDocument) => {
    container.innerHTML = "";
    pages
        ...
        const sections = page.sections.filter((section) => section.store === mode && section.position !== "system");
...
export const renderNavigation = (pages, onSelectDocument) => {
...
const renderSystemPages = (container, pages, onSelectDocument) => {
    container.innerHTML = "";
