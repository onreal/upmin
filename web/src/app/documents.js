import { downloadDocument, fetchDocument, updateDocument } from "../api";
...
import { moduleChecklistHtml as buildModuleChecklistHtml, normalizeModuleList, readSelectedModules, findModuleDefinition as findDefinition, } from "../features/modules/helpers";
...
export const renderDocumentView = (doc) => {
