...
const loadIframe = (iframe) => new Promise((resolve, reject) => {
...
const rewriteCssUrls = (cssText, baseUrl) => cssText.replace(/url\((["']?)(.*?)\1\)/gi, (_match, quote, rawUrl) => {
...
const absolutizeAttribute = (value, baseUrl) => {
...
const inlineCanvasSnapshots = (sourceDoc, clonedRoot) => {
...
const cloneWebsiteDocument = (doc) => {
...
const drawSvgToCanvas = async (svg) => {
