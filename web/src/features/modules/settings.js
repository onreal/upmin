...
export const fetchModuleSettings = async (auth, payload, moduleName, cache) => {
    if (!auth) {
        return null;
    }
...
export const ensureModuleSettingsDocument = async (auth, payload, module, cache) => {
    if (!auth) {
