import { updateIntegrationSettings } from "../../api";
import { state } from "../../app/state";
export const initIntegrationModal = ({ getAuth, reloadIntegrations, onAfterSave, }) => {
    ...
    integrationForm?.addEventListener("submit", async (event) => {
        ...
        for (const field of currentIntegration.fields) {
            const input = document.getElementById(`integration-${currentIntegration.name}-${field.key}`);
